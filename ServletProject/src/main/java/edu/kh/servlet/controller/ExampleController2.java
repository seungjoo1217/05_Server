 ...
 * <servlet> </setvlet-mappint> 를 작성하는 효과
 * 
 * */
...
public class ExampleController2 extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// req.setCharacterEncoding(LEGACY_DO_HEAD);
		// -> tomcat10 버전 이상부터 자동으로 인코딩 처리를 해주기 때문에 추가적인 처리 도움 X
		...
		// 누가 이것좀 대신 만들어줘라
		// -> JSP가 대신 화면을 보여줘라! (Servlet이 JSP에게 요청을 위임)
